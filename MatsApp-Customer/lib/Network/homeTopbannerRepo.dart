...
Future<TopBannerModel> fetchAdvertisement(
    String town, String pagetype, String position, String mobile, String apiKey,
    [String headingId]) async {
  Map data = {
    'Town': town,
    'pagetype': pagetype,
    'Position': position,
