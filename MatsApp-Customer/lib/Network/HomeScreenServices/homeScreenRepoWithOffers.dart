...
int zz = 0;
var result;
Future<HomePageWithOffersModel> fetchHomeDataOffers( bool refreshFlag,[
  String town,
  String mobile,
  String latitude,
  String longitude,
...
// Function to get the JSON String
      ...
      if (response.statusCode == 200) {
        result = HomePageWithOffersModel.fromMap(jsonDecode(response.body));
        return HomePageWithOffersModel.fromMap(jsonDecode(response.body));
      } else {
