...
class HotspotWidget2 extends StatefulWidget {
  const HotspotWidget2({Key key}) : super(key: key);

  @override
  _HotspotWidget2State createState() => _HotspotWidget2State();
}
...
class _HotspotWidget2State extends State<HotspotWidget2> {
  String apikey;
        ...
        builder: (BuildContext context, AsyncSnapshot<HotspotModel> snapshot) {
          if (snapshot.hasData) {
            return ListView.builder(
                itemCount: snapshot.data.allresult.length,
                shrinkWrap: true,
                              ...
                              children: [
                                Card(
                                  ...
                                  child: Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: snapshot
                                          .data.allresult[index].coverImageUrl,
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(snapshot.data.allresult[index]
                                                .openingTime ??
                                            ''),
                                        Text('-'),
                                        Text(snapshot.data.allresult[index]
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => StorePageProduction(
                                      snapshot.data.allresult[index].businessId,
                                      townSelectedStore,
                                      snapshot
                                          .data.allresult[index].businessName,
                                    )),
                          );
                        },
                      ),
