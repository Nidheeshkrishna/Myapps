...
class ExclusivedealsAdd2 extends StatefulWidget {
  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<ExclusivedealsAdd2> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore,
                'ExclusiveDeals', 'SecondBanner', mobileNumber, apikey);
          }),
