...
class ExclusivedealsAdd1 extends StatefulWidget {
  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<ExclusivedealsAdd1> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore,
                'ExclusiveDeals', 'TopBanner', mobileNumber, apikey);
          }),
