...
class CategoryWidgetAdd1 extends StatefulWidget {
  @override
  _DealsoftheDayAdd1State createState() => _DealsoftheDayAdd1State();
}

class _DealsoftheDayAdd1State extends State<CategoryWidgetAdd1> {
  ...
  void initState() {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBannerCatergory = fetchAdvertisement(townSelectedStore,
                'CategoryPage', 'TopBanner', mobileNumber, apikey);
          }),
