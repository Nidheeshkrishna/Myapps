...
class DiscountsForYouAdd2 extends StatefulWidget {
  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<DiscountsForYouAdd2> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore,
                'DiscountsForYou','SecondBanner', mobileNumber, apikey);
          }),
        });
  }
