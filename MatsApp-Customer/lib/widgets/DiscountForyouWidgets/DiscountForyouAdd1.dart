...
class DiscountForyouAdd1 extends StatefulWidget {
  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<DiscountForyouAdd1> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore,
                'DiscountsForYou', 'TopBanner', mobileNumber, apikey);
          }),
        });
  }
