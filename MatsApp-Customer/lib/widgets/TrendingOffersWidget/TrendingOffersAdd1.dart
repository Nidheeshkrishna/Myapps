...
class TrendingOffersAdd1 extends StatefulWidget {
  final String headingId;
  TrendingOffersAdd1([this.headingId]);

  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<TrendingOffersAdd1> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore, 'Others',
                'TopBanner', mobileNumber, apikey, widget.headingId);
          }),
