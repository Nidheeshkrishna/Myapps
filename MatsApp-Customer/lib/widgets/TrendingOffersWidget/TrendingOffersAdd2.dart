...
class TrendingOffersAdd2 extends StatefulWidget {
  
  final String headingId;
  TrendingOffersAdd2([this.headingId]);

  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<TrendingOffersAdd2> {
  ...
  void initState() {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore, 'Others',
                'SecondBanner', mobileNumber, apikey, widget.headingId);
          }),
