...
class HomeTopStores extends StatefulWidget {
  @override
  _HomeTopStoresWidgetState createState() => _HomeTopStoresWidgetState();
}

class _HomeTopStoresWidgetState extends State<HomeTopStores> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        topStoresdata.post.apiKeyStatus ?? false
            ? topStoresdata.post.top9Store != null
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Stack(children: <Widget>[
                                    ...
                                    child: AspectRatio(
                                      ...
                                      child: Card(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: topStoresdata.post
                                              .top9Store[index].coverImageUrl,
                                ...
                                topStoresdata.post.top9Store[index]
                                            .provideOffers !=
                                        "0"
                                    ? Align(
    ...
    return showDialog(
        ...
        builder: (context) {
          ...
          return AlertDialog(
            ...
            content: Text("Your Session Expired!"),
          );
        });
  }
