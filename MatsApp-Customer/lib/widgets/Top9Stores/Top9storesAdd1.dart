...
class Top9storesAdd1 extends StatefulWidget {
  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<Top9storesAdd1> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore,
                'Top9Stores','TopBanner', mobileNumber, apikey);
          }),
                  ...
                  return CarouselSlider.builder(
                    ...
                    itemBuilder:
                      ...
                      return InkWell(
                        ...
                        onTap: () {
                          if (snapshot
                              .data.result[index].redirectionUrl.isNotEmpty) {
                            _launchURL(
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => ProductPageTrending(
                                      ...
                                      snapshot.data.result[index].name,
                                      snapshot
                                          .data.result[index].redirectionId, snapshot.data.result[index].businessName)),
                            );
                          }
                        },
                      );
