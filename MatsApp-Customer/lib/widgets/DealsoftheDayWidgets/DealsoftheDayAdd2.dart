...
class DealsoftheDayAdd2 extends StatefulWidget {
  @override
  _ExclusivedealsAdd1State createState() => _ExclusivedealsAdd1State();
}

class _ExclusivedealsAdd1State extends State<DealsoftheDayAdd2> {
    ...
    dbHelper.getAll().then((value) => {
          setState(() {
            ...
            futureTopBanner = fetchAdvertisement(townSelectedStore,
                'DealOfTheDay', 'SecondBanner', mobileNumber, apikey);
          }),
          ...
          children: [
            FutureBuilder<TopBannerModel>(
              ...
              builder: (BuildContext context,
                  AsyncSnapshot<TopBannerModel> snapshot) {
                if (snapshot.hasData) {
                          ...
                          onTap: () {
                            if (snapshot.data.result[index].redirectionPage
                              ...
                              _launchURL(
                                ...
                                .data.result[index].redirectionPage
                                .contains("StorePage")) {
