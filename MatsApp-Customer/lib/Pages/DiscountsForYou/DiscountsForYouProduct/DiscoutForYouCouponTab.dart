...
class DiscoutForYouCouponTab extends StatefulWidget {
  final int productId;
  final String selectedtown;

  DiscoutForYouCouponTab(this.productId, this.selectedtown);

  @override
  _CouponsTabState createState() => _CouponsTabState();
}

class _CouponsTabState extends State<DiscoutForYouCouponTab> {
                                        ...
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  "${snapshot.data.result[index].discount}%",
                                                  style: TextStyle(
                                                      color: Colors.white,
                                                      fontWeight:
                                                          FontWeight.bold,
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                          "Until\r:${snapshot.data.result[index].expiryDate}",
                                                          style: TextStyle(
                                                            fontSize: 12,
                                                            fontWeight:
                                                                FontWeight.w500,
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              "\rRs\r${snapshot.data.result[index].couponValue}",
                                              style: TextStyle(
                                                  fontSize: 20,
