...
class DiscoutForYouProductdetailes extends StatefulWidget {
  final int productId;
  final String selectedTown;
  DiscoutForYouProductdetailes(this.productId, this.selectedTown);
  @override
...
class _DealsOtheDayProductdetailesState
    extends State<DiscoutForYouProductdetailes> {
