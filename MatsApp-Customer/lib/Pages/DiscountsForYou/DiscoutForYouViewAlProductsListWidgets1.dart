...
class DiscoutForYouViewAlProductsListWidgets1 extends StatefulWidget {
  //OfferCardStateless({Key key, this.choice}) : super(key: key);
  //final Choice choice;
  //final int businessId;
  //final String mobileNumber;
  final String selectedTown;
  DiscoutForYouViewAlProductsListWidgets1(this.selectedTown);
  @override
...
class _ProductsListWidgetsDealsofDayState
    extends State<DiscoutForYouViewAlProductsListWidgets1> {
  ...
  StreamController<DiscountForyouModel> _userController;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DiscountForyouModel>(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                        snapshot.data.list1[index].productName,
                              ...
                              Row(
                                ...
                                children: [
                                  snapshot.data.list1[index].matsappPrice !=
                                              ("0") &&
                                          snapshot.data.list1[index]
                                                  .matsappPrice !=
                                              null
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => DiscoutForYouProductPage(
                                snapshot.data.list1[index].productId,
                                townSelectedStore,
