...
class OffersViewAllList2 extends StatefulWidget {
  //OfferCardStateless({Key key, this.choice}) : super(key: key);
  //final Choice choice;
  //final int businessId;
  //final String mobileNumber;
  final String selectedTown;
  OffersViewAllList2(this.selectedTown);
  @override
  _OffersViewAllList1State createState() => _OffersViewAllList1State();
}

class _OffersViewAllList1State extends State<OffersViewAllList2> {
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      snapshot.data.list2[index].offerName,
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  snapshot.data.list2[index].offerPrice !=
                                              "0.000" &&
                                          snapshot.data.list2[index]
                                                  .offerPrice !=
                                              null
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  snapshot.data.list2[index].saveAmount !=
                                              "0" &&
                                          snapshot.data.list2[index]
                                                  .saveAmount !=
                                              null
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => ProductPageTrending(
                              snapshot.data.list2[index].offerId,
                              townSelectedStore,
  ...
  fetchdata() {
    ...
    offerCategoryViewAllFuture = fetchOffersViewall(townSelectedStore);
  }
