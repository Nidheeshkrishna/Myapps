      ...
      builder: (BuildContext context) {
        if (viewModel.redeemState.isBillScreen) {
          return CouponBill(
            ...
            purchaseLimit: viewModel.coupon.purchaseLimit,
...
class _VoucherSubmitWidgetState extends State<VoucherSubmitWidget> {
        ...
        child: Form(
            ...
            child: Column(children: [
              ...
              Container(
                  ...
                  child: widget.couponType.contains("Business")
                      ? TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600)))
                      : TextFormField(
                          initialValue: "${widget.purchaseLimit}",
                          readOnly: true,
                          keyboardType: TextInputType.number,
                          validator: _fieldValidation,
                          // onChanged: (val) {
                          ...
                          onSaved: (val) => setState(
                              () => _billAmount = widget.purchaseLimit),
                          style: TextStyle(
                              letterSpacing: 0.56,
                              fontSize: 22,
                              fontWeight: FontWeight.w600,
  ...
  String _fieldValidation(String value) {
    ...
    if (value?.isNotEmpty ?? false) {
      ...
      if (_amount < widget.purchaseLimit ?? 0.0) {
        return " Less then PurchaseLimit";
      } else {
        return null;
      }
    } else {
                  ...
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, position) {
                        ...
                        return AddonOptionItem(
                          child: VoucherListItem(voucher: voucher),
                          isSelected: voucher.id == selectedComboVoucher?.id,
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, position) {
                        ...
                        return AddonOptionItem(
                            ...
                            isSelected: coupon.couponId ==
                                selectedComboCoupon?.couponId,
