...
class RecycleVoucherWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return StoreConnector<AppState, RecycledVouchersViewModel>(
        onInitialBuild: (viewModel) {
          if (viewModel.vouchers.isEmpty||viewModel.vouchers.isNotEmpty)
           viewModel.getVouchers();
        },
        converter: (store) => RecycledVouchersViewModel.fromStore(store),
        onDispose: (store) =>
