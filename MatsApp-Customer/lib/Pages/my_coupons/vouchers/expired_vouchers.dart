...
class ExpiredVoucherWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return StoreConnector<AppState, ExpiredVouchersViewModel>(
        onInitialBuild: (viewModel) {
           //if (viewModel.vouchers.isEmpty)
          viewModel.getVouchers();
        },
        converter: (store) => ExpiredVouchersViewModel.fromStore(store),
        onDispose: (store) =>
