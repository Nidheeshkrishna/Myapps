...
import 'package:matsapp/Network/VoucherShareRepo.dart';
...
class ShareVoucher extends StatefulWidget {
  final String voucherId;

  ShareVoucher(this.voucherId);

  @override
  _ShareVoucherState createState() => _ShareVoucherState();
}

class _ShareVoucherState extends State<ShareVoucher> {
              ...
              content: ModalProgressHUD(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "You are Sharing this Voucher to",
