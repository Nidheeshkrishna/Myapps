...
class ProductsListWidgetsDealsofDay1 extends StatefulWidget {
  //OfferCardStateless({Key key, this.choice}) : super(key: key);
  //final Choice choice;
  //final int businessId;
  //final String mobileNumber;
  final String selectedTown;
  ProductsListWidgetsDealsofDay1(this.selectedTown);
  @override
...
class _ProductsListWidgetsDealsofDayState
    extends State<ProductsListWidgetsDealsofDay1> {
