...
class HelpAndGuide extends StatefulWidget {
  const HelpAndGuide({Key key}) : super(key: key);

  @override
  _HelpAndGuideState createState() => _HelpAndGuideState();
}

class _HelpAndGuideState extends State<HelpAndGuide> {
          ...
          child: Padding(
            ...
            child: Container(
                ...
                child: InAppWebView(
                  ...
                  initialUrlRequest:
                      URLRequest(url: Uri.parse(Urls.helpANDguide)),
