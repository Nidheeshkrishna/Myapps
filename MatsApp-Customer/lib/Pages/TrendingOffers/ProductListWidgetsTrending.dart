...
class ProductListWidgetsTrending extends StatefulWidget {
  //OfferCardStateless({Key key, this.choice}) : super(key: key);
  //final Choice choice;
  //final int businessId;
  //final String mobileNumber;
  final String selectedTown;
  ProductListWidgetsTrending(this.selectedTown);
  @override
...
class _ProductListWidgetsTrendingState
    extends State<ProductListWidgetsTrending> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<List1>>(
        stream: trendingBloc.list1Stream,
